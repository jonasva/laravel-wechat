...
class LaravelWechat
{
	...
	{
		$this->token = $config->get('laravel-wechat::token');
		$this->encodingAesKey = $config->get('laravel-wechat::encodingAesKey');
		$this->appid = $config->get('laravel-wechat::appId');
		$this->appsecret = $config->get('laravel-wechat::appSecret');
		$this->debug = $config->get('laravel-wechat::debug');
		$this->logcallback = $config->get('laravel-wechat::logCallBack');
	}
